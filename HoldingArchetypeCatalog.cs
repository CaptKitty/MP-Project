...
public static class HoldingArchetypeCatalog
{
    ...
    private static void EnsureBuilt()
    {
        ...
        Add("Freehold", "Freehold", HoldingCategory.FreeFarmers, 3, SocioEconomicClass.Citizen,
            5, 2, 0, 1, true, 1400, "LegionaryHeavy", "LegionaryLight");
        ...
        Add("Hamlet", "Hamlet", HoldingCategory.TribalSubsistence, 2, SocioEconomicClass.Freemen,
            3, 0, -40, 1, true, 1100, "Tribesman");
        Add("Village", "Village", HoldingCategory.TribalSubsistence, 3, SocioEconomicClass.Freemen,
            4, 0, -35, 1, true, 1500, "Tribesman_Chief", "Tribesman");

        Add("Manor", "Manor", HoldingCategory.EliteAgriculture, 1, SocioEconomicClass.Freemen,
            3, 2, 0, 2, false, 0, null, null, "Pro-Elite");
        Add("Estate", "Estate", HoldingCategory.EliteAgriculture, 2, SocioEconomicClass.Freemen,
            5, 4, 0, 3, false, 0, null, null, "Pro-Elite");
        Add("GreatEstate", "Great Estate", HoldingCategory.EliteAgriculture, 3, SocioEconomicClass.Freemen,
            7, 7, 0, 4, false, 0, null, null, "Pro-Elite");
        ...
        AddTransform(Get("Freehold"), "Estate", 45);
    }
        ...
        bool levies, int levyContribution, string levyUnit, string fallbackUnit = null, string allegiance = null)
    {
        ...
        item.foodConsumption = Mathf.Max(0, foodConsumption); item.suggestedAllegiance = allegiance;
    ...
    private static void AddTransform(HoldingDefinition source, string target, int minimumUrbanization = 0,
